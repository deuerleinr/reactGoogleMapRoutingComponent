    ...
    geocoder.geocode({ address: streetAddress }, (results, status) => {
      if (status === "OK") {
        ...
        this.setState({ positionDestination }, () => {
          const myMap = { center: this.state.positionDestination, zoom: this.state.zoom };
          ...
          <div className="root" ref={this.mountDiv}>
            <div className="address">
              <Row>
                {" "}
                <Col>
                  {this.state.showDirections && <span> Directions to: </span>} {this.props.name}
                  {" - "} {this.props.street}
                  {", "}
                  {this.props.city}
                  {", "}
